...
from locomonipulation_teleop_isaaclab.actuators import PaceDCMotorCfg
from isaaclab.assets.articulation import ArticulationCfg

from locomonipulation_teleop_isaaclab.assets import ISAAC_ASSET_DIR
...
PIPER_ARM_ACTUATOR_CFG = PaceDCMotorCfg(
    ...
    effort_limit=45.43,
    velocity_limit=15.7,
    stiffness={".*": 10.0},  # P gain in Nm/rad
    damping={".*": 1.5},  # D gain in Nm s/rad
